...
pub enum FilterPredicate {
    Equal { value: ScalarValue },
    NotEqual { value: ScalarValue },
    GreaterThan { value: ScalarValue },
    GreaterThanOrEqual { value: ScalarValue },
    LessThan { value: ScalarValue },
    LessThanOrEqual { value: ScalarValue },
    Between { min: ScalarValue, max: ScalarValue },
    In { values: Vec<ScalarValue> },
    IsNull,
    IsNotNull,
    Like { pattern: String },
